            ...
            <div className="row">
              <div className="col-6 flex items-center">
                {VisaCodeData1.map((data, index) => (
                  <div className="max-w-[248px] w-full rounded-xl bg-white flex flex-col items-center py-[18px] sm:py-5 md:py-7" key={index}>
              ...
              <div className="col-6">
                {VisaCodeData2.map((data, index) => (
                  <div className={`${index === 1 && "mt-9"} max-w-[248px] w-full rounded-xl bg-white flex flex-col items-center py-[18px] sm:py-5 md:py-7`} key={index}>
                    <img src={data.img} alt="images" />
