...
const Features = () => {
  ...
  return (
    <div className="2xl:max-w-[1536px] mx-auto relative overflow-hidden">
      <div className='container max-w-[1180px] py-20 lg:pb-0 lg:pt-[119px] lg:mb-[119px] main'>
        ...
        <div className="">
          ...
          <div className="flex lg:hidden justify-between">
            <div className="">
              {limitedFeatures.map((data, index) => (
                <div className="max-w-[391px] w-full mt-10" key={index}>
                  <div className="flex"><img src={data.img} alt="numbers" /></div>
