      ...
      <div className="container max-w-[1180px] relative z-20 heroCardSection">
        <div className="row items-center justify-center">
          {CARD_DATA.map((obj, index) => (
            <div className={`lg:col-4 md:min-h-[238px] min-h-[155px] ${index === 0 || index === 1 ? "max-md:mb-3 lg:mb-0" : "mb-0"} h-auto md:col-6 w-full flex items-center justify-center px-3 heroCardAnimation`} key={index}>
