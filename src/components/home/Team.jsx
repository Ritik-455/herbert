...
const Team = () => {
  return (
    <div className='relative max-w-[1536px] mx-auto lg:mt-36 md:mt-28 mt-20 sm:mb-8 lg:pt-36 xl:pb-60 md:pb-36 max-sm:mb-20 py-0'>
      ...
      <div className='absolute pointer-events-none lg:max-w-[701px] md:max-w-[630px] max-w-[500px] lg:h-[602px] h-auto right-0 -translate-y-1/2 top-1/2 z-20 pointer-events-none max-lg:opacity-30 sm:flex hidden'>
